...
options="${options} 'Forward prefix' '*' 'run-shell ~/.local/scripts/bin/tmux_toggle_prefix.sh'"
options="${options} 'Reload TMUX config' R 'run-shell ~/.local/scripts/bin/tmux_reload.sh'"
